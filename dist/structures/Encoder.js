...
class Encoder {
    ...
    */
    updateFrame() {
        ...
        if (!this.started)
            throw new CanvaGifError_1.CanvaGifError("You cannot add frame before encoder starts.", CanvaGifError_1.ErrorCode.ENCODER_ERROR);
    ...
    writePixels() {
        const encoder = new PixelWriter_1.default(this.width, this.height, { "pixels": this.indexedPixels, "colorDepth": this.colorDepth });
    ...
    */
    finish() {
        if (!this.started)
            throw new CanvaGifError_1.CanvaGifError(`You cannot finish encode before it starts.`, CanvaGifError_1.ErrorCode.ENCODER_ERROR);
    ...
    */
    setDelay(milliseconds) {
        if (this.started)
            throw new CanvaGifError_1.CanvaGifError(`You cannot change encode options after it starts.`, CanvaGifError_1.ErrorCode.ENCODER_ERROR);
